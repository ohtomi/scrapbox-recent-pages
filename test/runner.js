...
(() => {
    let actual = filterRecentPages(
        [
            ...
            {baseUrl: 'baseUrl6', project: 'project6', title: 'title6', updated: '1001'}
        ], 5, 'total');
    let expected = [
        {baseUrl: 'baseUrl1', project: 'project1', title: 'title1', updated: '1006'},
        {baseUrl: 'baseUrl2', project: 'project2', title: 'title2', updated: '1005'},
...
(() => {
    let actual = filterRecentPages(
        [
            ...
            {baseUrl: 'baseUrl1', project: 'project6', title: 'title6', updated: '1001'}
        ], 5, 'host');
    let expected = [
        {baseUrl: 'baseUrl1', project: 'project1', title: 'title1', updated: '1006'},
        {baseUrl: 'baseUrl1', project: 'project2', title: 'title2', updated: '1005'},
...
(() => {
    let actual = filterRecentPages(
        [
            {baseUrl: 'baseUrl1', project: 'project1', title: 'title1', updated: '1006'},
            {baseUrl: 'baseUrl1', project: 'project1', title: 'title2', updated: '1005'},
            {baseUrl: 'baseUrl1', project: 'project1', title: 'title3', updated: '1004'},
            {baseUrl: 'baseUrl1', project: 'project1', title: 'title4', updated: '1003'},
            {baseUrl: 'baseUrl1', project: 'project1', title: 'title5', updated: '1002'},
            {baseUrl: 'baseUrl1', project: 'project1', title: 'title6', updated: '1001'}
        ], 5, 'project');
    let expected = [
        {baseUrl: 'baseUrl1', project: 'project1', title: 'title1', updated: '1006'},
        {baseUrl: 'baseUrl1', project: 'project1', title: 'title2', updated: '1005'},
    ...
    if (!assertRecentPages(actual, expected)) {
        console.error('FAIL', 'test filter by project', actual, expected);
    }
})();
